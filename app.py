...
# 📂 โหลดไฟล์ Excel
# โปรดทราบ: เส้นทางไฟล์นี้ 'C:\Users\ACER\Downloads\workaw_chatbot\workaw_chatbot\workaw\FTE-DATASET.xlsx'
# เป็นเส้นทางแบบ Absolute ซึ่งอาจใช้งานไม่ได้เมื่อรันบนเซิร์ฟเวอร์อื่น
# ควรพิจารณาใช้เส้นทางแบบ Relative หรือจัดเก็บไฟล์ไว้ในที่เข้าถึงได้ง่ายขึ้น
file_path = r"C:\Users\ACER\Downloads\workaw_chatbot\workaw_chatbot\workaw\FTE-DATASET.xlsx"
try:
    df = pd.read_excel(file_path)
    file_content = df.to_string(index=False)
except Exception as e:
    st.error(f"Error reading file: {e}. โปรดตรวจสอบเส้นทางไฟล์ Excel.")
    st.stop()
